...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, AboutFragment.OnSeeMyWorkClickListener {
    ...
    //Handling SeeMyWorkButton clicked in aboutFragment
    @Override
    public void onSeeMyWorkClicked() {
        final ViewPager viewPager = findViewById(R.id.act_main_viewPager);
